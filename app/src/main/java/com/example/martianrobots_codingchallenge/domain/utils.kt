...
fun parseGridSize(inputX: String, inputY: String): Position? {
...
fun getRobotColor(orientation: Orientation): Color {
    return when (orientation) {
        Orientation.N -> Color.Cyan
        Orientation.S -> Color.Yellow
        Orientation.E -> Color.White
        Orientation.W -> Color.Blue
    }
}
